...
RSpec.describe Channel::Driver::Sms.massenversand do
  let(:gateway)         { 'https://gate1.goyyamovile.com/sms/sendsms.asp' }
  ...
  context 'when gateway response is invalid' do
    ...
    context 'when receiver is blocked' do
      ...
      it 'raises RuntimeError', :aggregate_failures do
        expect do
          instance.deliver(channel.options, { recipient: receiver_number, message: message_body })
