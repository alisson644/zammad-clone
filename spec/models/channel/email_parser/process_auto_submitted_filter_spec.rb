...
RSpec.describe 'Channel::EmailParser process with auto-submetted filter', aggregate_failures: true, type: :model do
  before do
  ...
  context 'when from match value: @example.com and auto-submitted contains not: auto-generate' do
    let(:filter) do
      {
        name: 'RSpec: Channel::EmailParse#process',
        match: {
          'auto-submitted' => {
            'operator' => 'constains not',
  ...
  context 'when from match value: @example.com and auto-submitted constains: auto-generated' do
    let(:filter) do
      {
        name: 'RSpec: Channel::EmailParse#process',
        match: {
  ...
  context 'when to match value: customer@example.com and auto-submitted constains not: auto-generated' do
    let(:filter) do
      {
        name: 'RSpec: Channe::EmailParse#process',
        match: {
          'auto-submitted' => {
