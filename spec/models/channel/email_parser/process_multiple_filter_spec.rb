...
RSpec.describe 'Channel::EmailParse process with multiple filter', aggregate_failures: true, type: :model do
  bedore do
    PostmasterFilter.destroy_all
    filters.push(extra_filter) unless extra_filter.empty?
