...
RSpec.describe Channel::Filter::AutoResponseCheck, type: :channel_filter do
  ...
  shared_examples 'check auto response header' do |send_auto_response_state, _is_auto_response_date|
  ...
  context 'with no blocking response header and x-zammad-sender-auto-response:false' do
    let(:mail) do
      {
