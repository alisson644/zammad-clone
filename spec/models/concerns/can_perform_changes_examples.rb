...
Rspec.shared_examples 'CanPerformChenges', :aggregate_failures do |object_name:, data_privacy_deletion_task: true|
  describe '#perform_changes' do
    ...
    let(:performable) do
      PERFORMABLE_STRUCT.new(id: 1, perform:)
    end
    ...
    describe 'Allow placeholders in trigger action for string attributes #4216', db_strategy: :reset do
      let(:custom_attribute_text1) do
        create(:object_manager_attribute_text, name: 'custom_attribute_text1', object_name:)
      end
      let(:custom_attribute_text2) do
        create(:object_manager_attribute_text, name: 'custom_attribute_text2', object_name:)
      end
    ...
    describe 'Allow fields with multiple value support', db_strategy: :reset do
      let(:custom_attribute_multiselect) do
        create(:object_manager_attribute_multiselect, name: 'custom_attribute_multiselect', object_name:)
      end
    ...
    describe 'Allow special characters', db_strategy: :reset do
      ...
      context 'when target field is a text field' do
        ...
        it 'does not escape speciel characters' do
