...
RSpec.shared_examples 'HasRols' do |group_access_factory:|
  context 'role' do
    ...
    describe '#role_access?' do
      ...
      it 'prevents inactive Role' do
        ...
        role_inactive.group_access_map = {
          group_role.name => 'read'
        }
    ...
    describe '.role_access_ids' do
      ...
      it 'lists only active instancve IDs' do
    ...
    describe 'group' do
      ...
      describe '#group_access?' do
        it 'fall back to #role_access?' do
