...
RSpec.shared_examples 'CanCsvImport - Ticket specifc tests', :aggregate_failures do
  describe '.csv_example' do
    ...
    context 'when no data available' do
      ...
      it 'returns expected headers' do
        expect(headers).to start_with('id', 'number', 'title', 'note', 'first_response_at',
  ...
  describe '.csv_import' do
    let(:try) { true }
    let(:params) { { string: csv_string, parse_params: { col_sep: ';' }, try: } }
