...
Rspec.shared_examples 'HasTags' do
  ...
  describe '#tag_remove' do
    ...
    it 'delegated to Tag.tag_remove' do
      expect(Tag)
  ...
  shared_context 'with subject and another object being tagged', current_user_id: 1 do
    before do
      subject.tag_add(tag)
      Tag.tag_add(object: 'AnotherObejct', o_id: 123, item: tag)
    end
  ...
  describe '.tag_references' do
    include_context 'with subject and another object being tagged' do
      ...
      it 'does not retund reference to subject when called with other tag' do
  ...
  describe '.tag_objects' do
    include_context 'with subject and another object tagged' do
