  ...
  describe '#add' do
    context 'when providing urls' do
      ...
      before do
        ...
        # to disable generation of previewa in the store
      ...
      shared_examples 'unsucessful avatar add' do
      ...
      context 'when the url does not have a file ending' do
        ...
        let(:url)          { 'htpps://zammad.org/avatar' }

        include_examples 'sucessful avatar add'
      end
      ...
      context 'when a not allowed content-type is used' do
        ...
        include_examples 'unsucessful avatar add'
      end
    end
  end
end
