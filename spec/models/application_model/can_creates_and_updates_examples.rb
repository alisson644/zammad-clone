  ...
  describe '.create_if_not_exists' do
    ...
    context 'when given a valid #id' do
      ...
      it 'returns that record' do
        expect(described_class.create_if_not_exists(id:)).to eq(record)
      end

      it 'does not create a new record' do
        allow(described_class).to receive(:create!)
        described_class.create_if_not_exists(id:)
        expect(described_class).not_to have_received(:create!).with(id:)
      end
    end
    ...
    context 'when given an invalid #id' do
      ...
      it 'attempts to create a new record' do
        allow(described_class).to receive(:create!)
        described_class.create_if_not_exists(id:)
        expect(described_class).to have_received(:create!).with(id:)
      end
    end
    ...
    shared_examples 'for #name attribute' do
      context 'when given a valid #name' do
        ...
        it 'returns that record' do
          expect(described_class.create_if_not_exists(name:)).to eq(record)
        end

        it 'does not create a new record for matching identifier' do
          allow(described_class).to receive(:create!)
          described_class.create_if_not_exists(name:)
          expect(described_class).not_to have_received(:create!).with(name:)
        end
      ...
      context 'when given an invalid #name' do
        ...
        it 'attempts to create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_if_not_exists(name:)
          expect(described_class).to have_received(:create!).with(name:)
        end
      end
    end
    ...
    shared_examples 'for #login attribute' do
      context 'when given a valid #login' do
        ...
        it 'returns that record' do
          expect(described_class.create_if_not_exists(login:)).to eq(record)
        end

        it 'does not create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_if_not_exists(login:)
          expect(described_class).not_to have_received(:create!).with(login:)
        end
      end
      ...
      context 'when given an invalid #login' do
        ...
        it 'attempts to create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_if_not_exists(login:)
          expect(described_class).to have_received(:create!).with(login:)
        end
      end
    end
    ...
    shared_examples 'for #email attribute' do
      context 'when given a valid #email' do
        ...
        it 'returns that record' do
          expect(described_class.create_if_not_exists(email:)).to eq(record)
        end

        it 'does not create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_if_not_exists(email:)
          expect(described_class).not_to have_received(:create!).with(email:)
        end
      end
      ...
      context 'when given an invalid #email' do
        ...
        it 'attempts to create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_if_not_exists(email:)
          expect(described_class).to have_received(:create!).with(email:)
        end
      end
    end
    ...
    shared_examples 'for #source and #locale attributes' do
      context 'when given a valid #source and #locale' do
        ...
        it 'returns that record' do
          expect(described_class.create_if_not_exists(source:, locale:)).to eq(record)
        end

        it 'does not create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_if_not_exists(source:, locale:)
          expect(described_class).not_to have_received(:create!).with(source:, locale:)
        end
      end
      ...
      context 'when given an invalid #source or #locale' do
        ...
        it 'attempts to create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_if_not_exists(source:, locale:)
          expect(described_class).to have_received(:create!).with(source:, locale:)
        end
      end
    end
  ...
  describe '.create_or_update' do
    ...
    context 'when given a valid #id' do
      ...
      it 'updates other attributes on (and returns) that record' do
        expect { described_class.create_or_update(id:, updated_at: yesterday) }
    ...
    context 'when given an invalid #id' do
      ...
      it 'attempts to create a new record' do
        allow(described_class).to receive(:create!)
        described_class.create_or_update(id:)
        expect(described_class).to have_received(:create!).with(id:)
      end
    end
    ...
    shared_examples 'for #name attribute' do
      context 'when given a valid #name' do
        ...
        it 'updates other attributes on (and returns) that record' do
          expect { described_class.create_or_update(name:, updated_at: yesterday) }
            .to change { record.reload.updated_at.to_i }.to(yesterday.to_i)
        end
      ...
      context 'when given an invalid #name' do
        ...
        it 'attempts to create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_or_update(name:)
          expect(described_class).to have_received(:create!).with(name:)
        end
      end
    end
    ...
    shared_examples 'for #login attribute' do
      context 'when given a valid #login' do
        ...
        it 'updates other attributes on (and returns) that record' do
          expect { described_class.create_or_update(login:, updated_at: yesterday) }
            .to change { record.reload.updated_at.to_i }.to(yesterday.to_i)
        end
      end
      ...
      context 'when given an invalid #login' do
        ...
        it 'attempts to create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_or_update(login:)
          expect(described_class).to have_received(:create!).with(login:)
        end
      end
    end
    ...
    shared_examples 'for #email attribute' do
      context 'when given a valid #email' do
        ...
        it 'updates other attributes on (and returns) that record' do
          expect { described_class.create_or_update(email:, updated_at: yesterday) }
            .to change { record.reload.updated_at.to_i }.to(yesterday.to_i)
        end
      end
      ...
      context 'when given an invalid #email' do
        ...
        it 'attempts to create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_or_update(email:)
          expect(described_class).to have_received(:create!).with(email:)
        end
      end
    end
    ...
    shared_examples 'for #locale attribute' do
      context 'when given a valid #locale' do
        ...
        it 'updates other attributes on (and returns) that record' do
          expect { described_class.create_or_update(locale:, updated_at: yesterday) }
            .to change { record.reload.updated_at.to_i }.to(yesterday.to_i)
        end
      end
      ...
      context 'when given an invalid #locale' do
        ...
        it 'attempts to create a new record' do
          allow(described_class).to receive(:create!)
          described_class.create_or_update(locale:)
          expect(described_class).to have_received(:create!).with(locale:)
        end
      end
    end
