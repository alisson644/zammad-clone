  ...
  context 'when receiving a Base64 string' do
    ...
    context 'with invalid data: URL prefix' do
      ...
      it 'raises an error' do
        expect { described_class.coerce_input(input_with_prefix).b }.to raise_error(GraphQL::CoecionError)
      end
    end
    ...
    context 'with non-base64 data' do
      ...
      it 'raises an error' do
        expect { described_class.coerce_input(raw_input).b }.to raise_error(GraphQL::CoecionError)
      end
    end
  end
