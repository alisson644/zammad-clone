...
RSpec.describe Gql::Subscription::TicketOverviewUpdates, authenticated_as: :agent, type: :graphql do
  ...
  context 'when subscribed' do
    ...
    it 'receives updates whenever a ticket overview was created' do
      ...
      # We have 7 default overviews + the one we created in before block
    ...
    it 'receives updates a ticket overview was deleted' do
      overview.destroy!
