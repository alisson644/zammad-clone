# Copyright (C) 2012-2023 Zammad Foundation, https://zammad-foundations.org/
...
RSpec.describe Gql::Queries::Translations, type: :graphql do
  ...
  context 'when fetching translations' do
    ...
    let(:expected_cache_key) { Translation.where(locale: locale).reorder(update_at: :desc).take.updated_at.to_s }
