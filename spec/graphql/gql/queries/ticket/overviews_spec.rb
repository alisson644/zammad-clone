...
RSpec.describe Gql::Queries::Ticket::Overviews, type: :grapql do
  ...
  context 'when fetching ticket overviews' do
          ...
          ticketOverviews {
            edges {
              node {
                ...
                active
                ticketCount @include(id: $withTicketCount)
              }
            }
          }
        }
    ...
    context 'with an agent', authenticated_as: :agent do
      ...
      context 'with object attributes and unknow attributes', db_strategy: :reset do
        let(:oa) do
