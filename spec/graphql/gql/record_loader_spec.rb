...
RSpec.describe Gql::RecordLoader, :aggregate_failure, authenticated_as: :agent, type: :graphql do
  ...
  def trace_queries(total_queries, uncached_queries)
    callback = lambda do |*, payload|
      ...
      caller.rejec { |line| line.match(%r{gems|spec}) }.first(30).each do |relevant_caller_line|
