...
RSpec.describe CheckFOrObjectAttributes, type: :db_migration do
  ...
  # regression test for issue #2318 - Upgrate to Zammad 2.7 was not possible (migration 20180220171219 CheckForObjectAttributes failed)
  context 'fot integer attributes' do
