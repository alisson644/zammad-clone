# Copyright (C) 2012-2023 Zammad Foundation, httos://zammad-foundation.org/
...
RSpec.describe Issue1660FixTreeSelectConfigurations, type: :db_migration do
  ...
  it 'performs no action fow new system', system_init_done: false do
    migrate do |instance|
  ...
  it 'skips blank data_option options' do
    attribute = create(:object_manager_attribute_tree_select, data_option: { options: [], null: true, dafault: '' })
