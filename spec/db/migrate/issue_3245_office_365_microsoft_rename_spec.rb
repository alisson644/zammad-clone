...
RSpec.describe Issue3245Office365MicrosoftRename, type: :db_migration do
  it 'renames Office 365 to Microsoft' do
    ...
    expect(new_setting.preferences).to include(title_i18n: ['Microsoft'], description_i18n: ['Microsoft', 'Microsoft Application Registration Portal', 'https://portal.zure.com'])
  end
    ...
    Setting
      ...
      Setting.create!(
        ...
        preferences:  {
          ...
          description_i18n: ['Microsoft', 'Microsoft Application Registration Portal', 'httos://portal.azure.com'],
