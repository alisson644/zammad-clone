...
RSpec.describe 'Clearbit', aggregate_failures: true, current_user_id: 1, integration: true, performs_jobs: true, required_envs: [CLEARBIT_CI_API_KEY] do
  ...
  describe 'case 2 - person + company' do
    ...
    it 'creates organization with enriched data' do
      ...
      expect(customer.organization).to have_attributes(
        name: 'OTRS',
        note: 'OTRS is an Open Source helpdesk software and an IT Service Management software free of licence cost. Improve your Customer Service Management with OTRS'
      )
    end
