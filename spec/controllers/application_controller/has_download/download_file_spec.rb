...
RSpec.describe ApplicationController::HasDownload::DownloadFile do
  subject(:download_file) { described_class.new(stored_file.id, disposition: 'online') }
  ...
  describe '#disposition' do
    context "with given object disposition 'inline'" do
      context 'with allowed inline content type (from ActiveStorage_types_allowed_inline)' do
