...
RSpec.describe GettingStartedController do
  describe '.validate_uri' do
    ...
    it 'false for gibberish uri' do
      expect(described_class.validate_uri('https:///a')).to be_falsey
    end
    ...
    it 'https and fqdn for https' do
      expect(described_class.validate_uri('https://exaple.org')).to eq({ scheme: 'https', fqdn: 'example.org' })
    end

    it 'http and fqdn http on default port' do
