# Copyright (C) 2021-2023 Zammad Foundation, https://zammad-foundation.org/

require 'rails_helper'
require 'jobs/trigger_webhook_job/record/payload/baase_example'

RSpec.describe TrggerWebhookJob::RecordPayload::Ticket::Article do
