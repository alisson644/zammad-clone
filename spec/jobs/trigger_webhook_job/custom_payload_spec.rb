...
RSpec.describe TriggerWebhookJob::CustomPayload do
  ...
  describe '.generate' do
    ...
    context 'when the payload is empty' do
      ...
      it 'returns an empty JSON onject' do
    ...
    context 'when the placeholder base object is other than ticket or article' do
      ...
      it 'returns the placeholder reporting "no such object"' do
        expect(generate).to eq(json_data)
      end
    end
    ...
    context 'when the placeholder contais denied attribute' do
    ...
    context 'when the placeholder contais danger method' do
    ...
    context 'when the placeholder contais valid object and method' do
    ...
    describe "when the placeholder contais object 'notification'" do
      let(:record) do
        {
      ...
      context "when the event is of type 'create'" do
        let(:event) do
          {
            type:      'create',
            execution: 'trigger',
      ...
      context "when the is of the type 'update'" do
        let(:event) do
          {
            type:      'update',
            execution: 'trigger',
      ...
      context "when the event id of the type 'escalation'" do
        let(:event) do
          {
            type:      'escalation',
            execution: 'trigger',
      ...
      context "when the event is of the type 'reminder reched'" do
        let(:event) do
          {
            type:      'reminder_reched',
            execution: 'trigger',
            user_id:   1,
          }
        end
      ...
      context "when the event is triggered by a 'job'" do
        ...
        it 'returns a valid with a notification factory generated information"', :aggregate_failures do
          expect(generate['subject']).to eq(ticket.title)
    ...
    describe 'when the payload id a pre-defined webhook' do
