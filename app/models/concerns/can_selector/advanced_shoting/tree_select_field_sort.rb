...
module CanSelector
  class AdvancedSorting
    class TreeSelectFieldSort < BaseSelectSort
      ...
      def self.applicable?(input, locale, object)
        ...
        return false unless attr.data_option[:translate]
      ...
      def initialize(input, locale, object)
        ...
        raise "#{self.class.name} can only be used with translatable fields" unless attr.data_options[:translate]
      end
