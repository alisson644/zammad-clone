...
class Channel::EmailParser::ContentParser
  ...
  rescue StandardError => e # Protect process to work with spam emails (see test/fixtures/mail15.box)
  ...
  def skip_attachments?(part, parent)
    ...
    return true if part_is_plain_alternative_in_mixed?(part, parent)
