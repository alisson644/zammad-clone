...
module Channel::Filter::ReplyToBasedSender
  def self.run(_channel, mail, _transaction_params)
    ...
    ail[:origin_from_display_name] = mail[:from_display_name]
    ...
    Rails.logger.error "Invalid value for 'postmaster_sender_based_on_reply_to' -> #{setting.inspect}"
  end
