...
class Channel::Driver::Sms::Massenversand
  ...
  def send_create(options, attr)
    ...
    message = "Receive non-OK response from gateway URL '#{url}'"
  ...
  def self.definition
    {
      ...
      notification: [
        { name: 'options::gateway', display: __('Gateway'), tag: 'input', type: 'text', limit: 200, null: false,
          placeholder: 'https://gate1.goyyamobile.com/sms/sendsms.asp', default: 'https://gate1.goyyamobile.com/sms/sendsms.asp' },
