...
class AI::Agent::Type::CustomAIAgent < AI::Agent::Type
  ...
  def description
    __('This is a custom AI Agent type that allows full control over all of its parts. You can define the role description, instruction and its context, entity context, result strutucture, and action defintion.')
  end
