...
module ApplicationController::SetsHeaders
  ...
  # For all responses in this controllr, return the CORS access control headers.
  ...
  def set_access_control_headers_execute
    ...
    headers['Access-Control-Allow-Headers'] =
      'Content-Type, Depth, User-Agent, X-File-Size, X-Requested-With, If-Modified-Since, X-File-Name, Cache-Control, Accept-Language'
  end
